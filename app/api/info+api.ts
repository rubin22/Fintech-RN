...
export const data = {
  '1': {
    ...
    category: 'coin',
    description:
      'Bitcoin (BTC) is a cryptocurrency launched in 2010. Users are able to generate BTC through the process of mining. Bitcoin has a current supply of 19,666,518. The last known price of Bitcoin is 70,440.11703006 USD and is up 0.26 over the last 24 hours. It is currently trading on 10944 active market(s) with $43,131,510,432.09 traded over the last 24 hours. More information can be found at https://bitcoin.org/.',
    slug: 'bitcoin',
  ...
  '825': {
    ...
    category: 'token',
    description:
      'Tether USDt (USDT) is a cryptocurrency and operates on the Ethereum platform. Tether USDt has a current supply of 107,792,615,136.84982 with 104,454,161,510.77856 in circulation. The last known price of Tether USDt is 0.99993989 USD and is down -0.01 over the last 24 hours. It is currently trading on 80513 active market(s) with $88,381,037,449.21 traded over the last 24 hours. More information can be found at https://tether.to.',
    slug: 'tether',
  ...
  '1027': {
    ...
    category: 'coin',
    description:
      'Ethereum (ETH) is a cryptocurrency . Ethereum has a current supply of 120,071,842.29241183. The last known price of Ethereum is 3,573.90975097 USD and is down -0.42 over the last 24 hours. It is currently trading on 8662 active market(s) with $20,922,582,828.82 traded over the last 24 hours. More information can be found at https://www.ethereum.org/.',
    slug: 'ethereum',
  ...
  '1839': {
    ...
    category: 'coin',
    description:
      'BNB (BNB) is a cryptocurrency . BNB has a current supply of 149,536,454.93789622. The last known price of BNB is 584.39986067 USD and is up 0.90 over the last 24 hours. It is currently trading on 2125 active market(s) with $2,262,429,578.69 traded over the last 24 hours. More information can be found at https://bnbchain.org/en.',
    slug: 'bnb',
  ...
  '5426': {
    ...
    category: 'coin',
    description:
      'Solana (SOL) is a cryptocurrency launched in 2020. Solana has a current supply of 572,741,985.8772048 with 444,291,496.8078719 in circulation. The last known price of Solana is 184.71046428 USD and is down -1.91 over the last 24 hours. It is currently trading on 649 active market(s) with $3,667,701,567.45 traded over the last 24 hours. More information can be found at https://solana.com.',
    slug: 'solana',
